...
_FEATURES: tuple[Feature, ...] = (
    ...
    Feature("dist_20ema_pct", 1, "float",
            "% distance from 20-EMA; positive = extended above", -100, 500, -40, 80),
    Feature("dist_50dma_pct", 1, "float",
            "% distance from 50-DMA; positive = above trend", -100, 500, -60, 120),
    Feature("pct_from_pivot", 1, "float",
            "% distance from the decision-time pivot/trigger", -100, 500, -20, 50),
    Feature("base_depth_pct", 1, "float", "base/consolidation depth %", 0, 100, 0, 50),
    Feature("base_days", 1, "float", "base/consolidation age in sessions", 0, 2000, 0, 500),
    Feature("volume_ratio", 1, "float", "current volume divided by reference volume", 0, 100, 0, 20),
    Feature("contraction_ratio", 1, "float",
            "volatility/range contraction ratio; smaller = tighter", 0, 20, 0, 5),
    Feature("rs_percentile", 1, "float", "relative-strength percentile", 0, 100),
    Feature("sector_rank_percentile", 1, "float", "sector-strength percentile", 0, 100),
    Feature("volatility_percentile", 1, "float", "volatility percentile", 0, 100),
    Feature("reward_risk", 1, "float", "decision-time target reward / stop risk", -20, 100, 0, 20),
    ...
    Feature("correlation_regime", 1, "categorical", "cross-sectional correlation regime",
            categories=("LOW", "NORMAL", "HIGH", "UNKNOWN")),
