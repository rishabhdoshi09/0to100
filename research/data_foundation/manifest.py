...
def build_manifest(
    *,
    ...
    body = {
        ...
        "as_of": as_of,
        "price_store": {
            "path": str(bhav_pkl) if bhav_pkl.exists() else None,
            "hash": _sha_file(bhav_pkl) if bhav_pkl.exists() else None,
        },
        "ca_ledger": {
            "path": str(ca_events_path()),
            "hash": _sha_file(Path(ca_events_path())),
        },
        "universe_history": {
            "path": str(history_path()),
            "hash": _sha_file(Path(history_path())),
        },
        "fundamentals": {
            "path": str(fund_path()),
            "hash": fund_hash(),
