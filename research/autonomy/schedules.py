...
def snapshot_decision_key(snapshot_id: str) -> str:
    """Closed-market selection/autopilot decision with no execution authority."""
    return f"snapshot_decision:{snapshot_id}"
