...
def main() -> None:
    ...
    payload = {
        ...
        "infy_q1_invisible_on_2026_06_10": (future.get("available_from") or "") < "2026-07-23",
    ...
    if not live_locked:
        raise RuntimeError("Phase H refused: canonical live-execution interlock is not verified locked")
