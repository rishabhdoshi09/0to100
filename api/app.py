...
The executable runtime implementation lives in :mod:`api.runtime`.  This is the
single public backend boundary used by the launcher and new code.  Historical
module names remain compatibility shims only and must not own routes or runtime
behaviour.
"""
