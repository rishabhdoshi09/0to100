...
# Optional KPIs never reduce score or decision coverage when absent.
...
BANK = (
    ...
    _k(
        ...
        higher_is_better=True, kind="rate", unit="%", pillar="funding", weight=8,         missing_ok=True, importance="important",
    ),
    _k(
        "cet1", "CET1", "quarterly_results",
        ("cet1", "common equity tier"),
        higher_is_better=True, kind="rate", unit="%", pillar="capital", weight=8,
        missing_ok=True, importance="important",
    ),
    _k(
        "crar", "CRAR / capital adequacy", "quarterly_results",
        ("crar", "capital adequacy"),
        higher_is_better=True, kind="rate", unit="%", pillar="capital", weight=6,
        missing_ok=True, importance="important",
    ),
    _k(
        "advances", "Advances / loans", "balance_sheet",
        ("gross advances", "net advances", "total advances"),
        higher_is_better=True, kind="level", unit="₹ cr", pillar="growth", weight=6,
        missing_ok=True, importance="important",
    ),
    _k(
        "deposits", "Deposits", "balance_sheet",
        ("deposits", "total deposits"),
        higher_is_better=True, kind="level", unit="₹ cr", pillar="funding", weight=6,
        missing_ok=True, importance="important",
    ),
    _k(
        "pcr", "Provision coverage (PCR)", "quarterly_results",
        ("pcr", "provision coverage"),
        higher_is_better=True, kind="rate", unit="%", pillar="asset_quality", weight=6,
        missing_ok=True, importance="supporting",
    ),
    _k(
        "slippages", "Slippages", "quarterly_results",
        ("slippage", "slippages"),
        higher_is_better=False, kind="rate", unit="%", pillar="asset_quality", weight=5,
        missing_ok=True, importance="important",
    ),
    _k(
    ...
    _k(
        ...
        higher_is_better=False, kind="rate", unit="%", pillar="funding", weight=4,
        missing_ok=True, importance="supporting",
    ),
    _ROA, _ROE,
    _FII, _DII, _PUBLIC,
...
NBFC = (
    ...
    _k(
        ...
        higher_is_better=True, kind="level", unit="₹ cr", pillar="growth", weight=8,         missing_ok=True, importance="important",
    ),
    _FII, _DII, _PUBLIC,
)
...
INDUSTRIALS = (
    _GROWTH_SALES, _OPM, _PAT,
    replace(_CFO, importance="critical"),
    _PROMOTER, _PLEDGE, _DEBT, _ROE, _ROCE,
    _FII, _DII, _PUBLIC,
)
...
FRAMEWORKS: dict[str, dict[str, Any]] = {
    "bank": {
        "id": "bank",
        "label": "Banks",
        "blurb": "Asset quality, NIM, and profit trend — not generic D/E.",
        "kpis": BANK,
        "min_critical": 2,
        "min_decision_coverage": 0.45,
        "min_score_coverage": 0.40,
        "watch": (
