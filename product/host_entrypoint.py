...
optional operator-owned environment file, then hands ownership to the canonical
host supervisor.  No credential value is logged or written back to disk here.
"""
